...
namespace Services.ProdajaServisi
{
    public class ProdajaServisi : IProdajaServis
    {
        ...
        public ProdajaServisi(IVinaRepozitorijum vinaRepozitorijum, ILoggerServis loggerServis, IFaktureRepozitorijum faktureRepozitorijum,
            IPaleteRepozitorijum paleteRepozitorijum, ISkladistenjeServis skladistenjeServis)
